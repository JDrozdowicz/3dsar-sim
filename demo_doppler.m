...
point = [
    100,0,0,1,0,100,0,0; %nonzero velocity
    100,0,0,1,0,-200,0,0;
    100,0,0,1,0,0,0,0; %zero velocity
    ];
...
for iter_pos = 1:size(tx_pos,1)
    ...
    fd = doppler(fc,point(:,1:3),tx_pos,rx_pos,point(:,6:8));
    raw_data(iter_pos,:) = sim_resp(fc, B, T, cell_size, start_range, end_range, curr_point, tx_pos(iter_pos,:), rx_pos(iter_pos,:),fd);
